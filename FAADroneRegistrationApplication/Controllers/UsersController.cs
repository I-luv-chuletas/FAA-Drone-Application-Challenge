...
namespace FAADroneRegistrationApplication.Controllers
{
    public class UsersController : Controller
    {
        ...
        public UsersController(FAADroneRegistrationApplicationContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,FirstName,LastName,Address,DroneIdNumber")] Users users)
        {
            if (id != users.ID)
            {
                return NotFound();
